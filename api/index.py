...
if not SUPABASE_URL or not SUPABASE_KEY:
    ...
    print("Make sure you have set SUPABASE_URL and SUPABASE_KEY (in .env for local, or in Vercel env vars).")
else:
    try:
...
# HTML for homepage (user enters their name)
home_page = """
<!DOCTYPE html>
<html lang="en">
<head>
...
# Full profile page (use .replace("{{ name }}", name) to show user's name)
profile_page = """
<!DOCTYPE html>
<html lang="en">
<head>
